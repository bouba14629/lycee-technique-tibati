...
- [x] Analyser les modèles de matières, cours, emplois du temps et bulletins pour la matière CO.
- [x] Ajouter CO à toutes les classes sans coefficient ni type d’enseignement.
- [x] Rendre CO disponible uniquement dans la programmation de l’emploi du temps.
- [x] Exclure CO des bulletins, moyennes, notes et exports PDF.
- [x] Ajouter les tests CO pour toutes les classes, les rôles, l’emploi du temps et les bulletins.
- [x] Compiler, sauvegarder et publier la correction CO.
- [x] Garantir la persistance de coefficient et catégorie vides pour CO lors de toute création future.
- [x] Exclure CO des évaluations planifiées, indicateurs et vues de notes restantes.
- [x] Couvrir les rôles censeur, directeur, enseignant, élève, parent et conseiller dans les tests CO.
- [x] Tester la programmation et l’affichage de CO dans les emplois du temps ainsi que les exports bulletin/PDF.
- [x] Filtrer CO de toutes les listes d’évaluations planifiées disponibles.
- [x] Tester explicitement les rôles censeur et conseiller d’orientation.
- [x] Tester la programmation CO par POST et l’exclusion de CO dans un PDF de bulletin.
- [ ] Sauvegarder le checkpoint et publier la correction CO.
