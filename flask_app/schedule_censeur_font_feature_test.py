...
assert 'can_build_schedule = user.role in ("censeur", "directeur")' in routes
assert 'can_create_tronc_commun = bool(current_class) and user.role in ("censeur", "directeur")' in routes
...
assert 'font-size: 11pt;' in pdf
assert 'font-size: 9.4pt;' in pdf
