...
assert "font-size: 12pt; height: 54pt" in schedule_pdf
assert ".subj { font-weight: bold; font-size: 12pt" in schedule_pdf
assert ".teach { display:inline-block; margin-top:3pt; font-style: italic; color: #000; font-size: 10.4pt" in schedule_pdf
