...
assert "font-size: 11pt; height: 46pt" in schedule_pdf
assert ".subj { font-weight: bold; font-size: 11pt" in schedule_pdf
assert ".teach { font-style: italic; color: #666; font-size: 9.4pt" in schedule_pdf
